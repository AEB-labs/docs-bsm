...
metadata:
  robots: index
---
After performing a check, the status of the check result may change. For instance, you executed a screening check that results in a _critical_ check result. Defining a good guy for the critical address will change the compliance status to _not critical_.
