...
| API  | Function                                                                                                                                                                                                                                                                                                      |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| REST | <Anchor label="POST getCheckResult" target="_blank" href="https://rz3.aeb.de/test2bsm/swagger/">POST getCheckResult</Anchor>                                                                                                                                                                                  |
...
To execute the function, you have to provide the system id of the pre-system (_clientSystemid_), the BSM client (_clientIdentCode_), an username and the ID of the business object:
